...
from app.services import direction_1d_sprint_market_gap_ablation as us_etf  # noqa: E402
...
def main():
    ...
    lock_path = base.ROOT / "run.lock" if action in ("run", "tick", "report") else base.ROOT / "round74-training.lock"
