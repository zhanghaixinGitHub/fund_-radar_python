"""第121轮独立训练入口；前向层另行绑定，不改变Windows运行链。"""
...
from app.services import direction_1d_sprint_market_stock_moneyflow_v2 as model  # noqa: E402
...
def main():
    ...
    path = base.ROOT / "round121-prepare.lock"
