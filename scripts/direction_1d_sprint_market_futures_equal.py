"""第101轮固定组合入口；复用已冻结模型，组合验证使用独立互斥锁。"""
...
from app.services import direction_1d_sprint_market_futures_equal as model  # noqa: E402
...
def main():
    ...
    path = base.ROOT / ("round101-prepare.lock" if action in ("plan", "prepare") else "run.lock")
