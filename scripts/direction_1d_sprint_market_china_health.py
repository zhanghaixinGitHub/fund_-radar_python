"""第104轮研究及前向入口；运行仅接CORE3当前模型，准备训练使用独立互斥锁。"""
...
from app.services import direction_1d_sprint_market_china_health as model  # noqa: E402
...
def main():
    ...
    path = base.ROOT / ("round104-prepare.lock" if action in ("plan", "prepare") else "run.lock")
