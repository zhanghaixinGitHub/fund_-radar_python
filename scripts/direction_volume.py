"""量价固定实验：先probe和freeze，再补数、训练、评价、封存及复跑。"""

import argparse
import json
from uuid import UUID

from app.services import direction_volume_runner as runner
...
def main():
    ...
    parser.add_argument(
        "action", choices=("freeze", "acquire", "prepare", "predict", "score", "finalize", "verify", "replay")
    )
