"""尾部比例复用R109实际原文；每次将派生值与已实际收到的响应绑定，新增请求为零。"""
...
def load_live(t, u, ph):
    """按父计划校验实际T原文及收据；不加载历史T，不将缺失替换成零比例。"""
    parent.require(ph == b.digest(b.read(b.ROOT / "round-116/plan.json")), "TAIL_MODEL_PLAN_CHANGED")
