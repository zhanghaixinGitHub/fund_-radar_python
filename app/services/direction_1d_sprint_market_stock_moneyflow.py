"""第117轮：T日沪深订单分类买卖金额，保持原标签、训练样本和对照。"""
...
INTENT_HASH = "f482d7b9b2633be3588550f3494c281dc60c52eacf98d9cb3350cf853d527012"
PROPOSAL_HASH = "PENDING_COMPLETE_SOURCE_IDENTITY"


def root():
    return base.ROOT / "round-117"
...
def fingerprint():
    ...
    for name, expected in source_plan["code"].items():
        ...
        code[name] = expected
    for name in (
        "app/services/direction_1d_sprint_market_stock_moneyflow.py",
        "scripts/direction_1d_sprint_market_stock_moneyflow.py",
        "tests/test_direction_1d_sprint_market_stock_moneyflow.py",
        "app/services/direction_1d_sprint_stock_moneyflow_data.py",
        "tests/test_direction_1d_sprint_stock_moneyflow_data.py",
    ):
