"""沪深300海外ETF成交价格的一日输入，历史开发与真实08:30前采集各自留证。"""
...
from app.integrations.sina_sprint_ashare_etf import MAX_BYTES, fetch_etf, parse, url_for
...
SYMBOLS = ("ASHR",)
SOURCE = "SINA_ASHARE_ETF_QUOTE_V1"
...
def root():
    return base.ROOT / "round-63/ashare-inputs"
...
def history():
    ...
    folder = base.ROOT / "ashare-etf-source-v1"
