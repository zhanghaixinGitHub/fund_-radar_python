...
from app.services import direction_1d_sprint_china_internet as s
...
def test_entry_keeps_previous_round_and_attempts_new_after_failure(monkeypatch):
    from scripts import direction_1d_sprint_china_internet as entry

    assert entry.existing.__name__ == "scripts.direction_1d_sprint_stacking_monotonic"
