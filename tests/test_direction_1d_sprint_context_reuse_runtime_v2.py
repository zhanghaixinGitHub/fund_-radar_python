...
import pytest
from app.services import direction_1d_sprint_context_reuse_runtime_v2 as s
...
def binding(monkeypatch, tmp_path):
    ...
    plan = {
        ...
        "native_preflight_rounds": [117, 118, 119, 120],
...
def test_valid_bindings_do_not_create_or_modify_native_model_plan(binding):
    ...
    assert s.bindings(120) == (plan, module)
