...
import numpy as np
import pytest
from app.services import direction_1d_sprint_market_only as s
...
def test_new_entry_runs_independent_branch_even_when_old_branch_fails(monkeypatch):
    from scripts import direction_1d_sprint_market_only as entry

    assert entry.existing.__name__ == "scripts.direction_1d_sprint_etf_fundstate_linear"
